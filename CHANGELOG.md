...
- **Explorer**: move files and folders to different paths via command palette ("Move file", "Move file or directory"); destination folder selected via fuzzy-searchable directory picker; file/folder keeps its original name; workspace boundary validation; directory move updates all open tabs
