...
- **Command palette**: "Open File..." enumerates workspace files and fuzzy-matches on relative paths. Hidden files (dot-prefixed) are included or excluded based on the `show_hidden_files` setting; `.git/` contents are always excluded.
