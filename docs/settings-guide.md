...
| `word_wrap`, `syntax_theme`, `ui_theme`, `warn_line_ending`, `show_hidden_files`, `dim_gitignored`, `dim_hidden_files`, `show_git_status`, `show_indentation_guides`, `path_display_mode`, `sidebar_width` | always | — | — |
