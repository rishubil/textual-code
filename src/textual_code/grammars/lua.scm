...
; License: MIT
; Copyright (c) tree-sitter-grammars contributors
...
(elseif_statement ["elseif" "then" "end"] @conditional)
(else_statement ["else" "end"] @conditional)
...
(table_constructor
  (field name: (identifier) @function value: (function_definition)))
